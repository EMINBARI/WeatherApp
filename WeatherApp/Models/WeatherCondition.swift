...
//
//   let weatherCondition = try? newJSONDecoder().decode(WeatherCondition.self, from: jsonData)

import Foundation

// MARK: - WeatherConditionElement
struct WeatherConditionElement: Codable {
    let code: Int
...
typealias WeatherCondition = [WeatherConditionElement]
